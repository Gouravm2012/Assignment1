...
🚀 How to Run
Since this project does not require a build step or local server, you can run it directly in your web browser.

Make sure all three files (index.html, style.css, and script.js) are in the same directory.

Open the index.html file with your favorite web browser (like Chrome, Firefox, or Edge).

The application will load, and you can start searching for books right away!
